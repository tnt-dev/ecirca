...
set(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    return enif_make_tuple(env,2,enif_make_atom(env, "ok"),enif_make_tuple(env,2,enif_make_uint(env, old_val),enif_make_uint(env, new_val)))
                                                               ;
}
...
update(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    else if (val != (4294967295U) && ctx->circa[idx] != (4294967295U)) {
...
save(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    *((typeof(28)*)(bin_data + i)) = 28; i += sizeof(28);;
...
static ErlNifFunc functions[] =
{
 ...
 ErlNifEntry* nif_init(void); ErlNifEntry* nif_init(void) { static ErlNifEntry entry = { 2, 2, "ecirca_medium", sizeof(functions) / sizeof(*functions), functions, &init, ((void *)0), ((void *)0), ((void *)0), "beam.halfword" }; ; return &entry; }
